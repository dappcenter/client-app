...
export default {
  ...
  meta: {
    meta: {
      description: { name: 'description', content: 'TRXPlorer.io is a blockchain explorer for the Tron protocol. You can track every block, transactions, addresses, coins/tokens or other assets of the Blockchain.' }
    }
  },
  data () {
    return {}
